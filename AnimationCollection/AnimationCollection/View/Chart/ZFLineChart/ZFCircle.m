...
- (UIBezierPath *)noFill{
    ...
    UIBezierPath * bezierCircle;
    if ([_PointStyle isEqual:PointsCircle]) {
         bezierCircle = [UIBezierPath bezierPathWithOvalInRect:CGRectMake(_radius, _radius, 0, 0)];
    }else if ([_PointStyle isEqual:PointsSquare]) {
       bezierCircle = [UIBezierPath bezierPathWithRect:CGRectMake(_radius, _radius, 0, 0)];
...
- (UIBezierPath *)fill{
    ...
    UIBezierPath * bezierCircle;
    if ([_PointStyle isEqual:PointsCircle])  {
        bezierCircle = [UIBezierPath bezierPathWithOvalInRect:CGRectMake(0, 0, _radius * 2, _radius * 2)];
        
    }else if ([_PointStyle isEqual:PointsSquare])  {
        bezierCircle = [UIBezierPath bezierPathWithRect:CGRectMake(0, 0, _radius * 2, _radius * 2)];
